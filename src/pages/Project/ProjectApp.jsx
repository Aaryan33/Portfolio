        ...
        <div>
            ...
            <main>
                ...
                <section className="projects__grid apps">
                    ...
                    <div className="projects__item">
                        <button onClick={() => cambiarEstadoModal13(!estadoModal13)}>
                            <img src={proyectsImgApp(`./proyecto-app-13.jpg`)} alt="" className="projects__img" />
                        </button>
                    </div>
                    <div className="projects__item">
                        <button onClick={() => cambiarEstadoModal12(!estadoModal12)}>
                            <img src={proyectsImgApp(`./proyecto-app-12.jpg`)} alt="" className="projects__img" />
                        </button>
                    </div>
                    <div className="projects__item">
                        <button onClick={() => cambiarEstadoModal11(!estadoModal11)}>
                    ...
                    <div className="pw-content">
                        ...
                        <div className="eins-modal-text">
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <button href="https://ev-charge-locatorr.netlify.app" target="_blank">https://ev-charge-locatorr.netlify.app</button>
                            </div>
                ...
                <div className="content-modal">
                    <div className="pw-content">
                        ...
                        <div className="eins-modal-text">
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <button href="https://github.com/Aaryan33/TripVerse" target="_blank">https://github.com/Aaryan33/TripVerse</button>
                            </div>
                            <div className="eins-modal-text-3">
                                <span>
                                    <FormattedMessage
                ...
                <div className="content-modal">
                    <div className="pw-content">
                        ...
                        <div className="eins-modal-text">
                            ...
                            <div className="eins-modal-text-2">
                                <span>Link:</span> <button href="https://ev-rent.netlify.app/" target="_blank">https://ev-rent.netlify.app/</button>
                            </div>
                            <div className="eins-modal-text-3">
                                <span>
                                    <FormattedMessage
